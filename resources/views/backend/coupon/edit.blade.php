                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="value" value="{{$coupon->value}}" class="form-control">
                                        </div>
                                    </div>
                                </div>  
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="type" aria-label="Default select example">
                                                ...
                                                <option value="fixed" {{$coupon->type=='fixed'?'selected':''}} class="text-capitalize">fixed</option>
                                                <option value="percent" {{$coupon->type=='percent'?'selected':''}} class="text-capitalize">percent</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
