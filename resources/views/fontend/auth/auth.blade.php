...
@section('content')
    <main class="main">
        ...
        <div class="login-page bg-image pt-8 pb-8 pt-md-12 pb-md-12 pt-lg-17 pb-lg-17"
            style="background-image: url('{{ asset('fontend/assets/images/backgrounds/login-bg.jpg') }}')">
            <div class="container">
                <div class="form-box">
                    <div class="form-tab">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                                <form action="{{ route('login.submit') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="singin-email-2" name="email" value="{{old('email')}}" required>
                                        @error('email')
                            ...
                            <div class="tab-pane fade show active" id="register-2" role="tabpanel"
                                ...
                                <form action="{{route('regiter.submit')}}" method="POST">
                                     @csrf
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="register-email-2" name="full_name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="register-email-2" name="username"
