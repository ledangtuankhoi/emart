                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="first_name"
                                                value="{{ $name[0] }}" readonly>
                                        </div><!-- End .col-sm-6 -->

                                        <div class="col-sm-6">
                                            <label>Last Name *</label>
                                            <input type="text" class="form-control" name="last_name"
                                                value="{{ $name[1] }}" readonly>
                                        </div><!-- End .col-sm-6 -->
                                    </div><!-- End .row -->
                                    <label>Country *</label>
                                ...
                                <div id="address-ship " class="list-group-item-success px-2 pb-1 "
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="checkout-diff-address">Ship to
                                            a different address?</label>
                                    </div><!-- End .custom-checkbox -->
                                </div>


                                {{-- ship 1 địa điểm khác --}}

                                <div id="diff-address" style="display: none">
                                    <div id="address-ship " class="list-group-item-success px-2 pb-1 "
                                        style="  border-top-style: solid; border-top-color: green; border-radius: 10px ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <label>First Name *</label>
                                                <input type="text" class="form-control" name="sfirst_name"
                                                    value="{{ $sname[0] }}">
                                            </div><!-- End .col-sm-6 -->

                                            <div class="col-sm-6">
                                                <label>Last Name *</label>
                                                <input type="text" class="form-control" name="slast_name"
                                                    value="{{ $sname[1] }}">
                                            </div><!-- End .col-sm-6 -->
                                        </div><!-- End .row -->
                            ...
                            <aside class="col-lg-5">
                                <div class="summary p-2">
                                    ...
                                    {{-- chon dichj vuj ship --}}
                                    <div style="  border-top-style: solid; border-top-color: green; border-radius: 10px ">
                                                            ...
                                                            <div class="form-check">
                                                                <th scope="row" class="px-2">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="{{ $item->delivery_charge, 2 }}" required>
                                                                <th>
                                                    ...
                                                    <h2 class="card-title">
                                                        <div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="DBT" value="DBT"
                                                                    name="payment_method" class="custom-control-input"
                                                                    role="button" data-toggle="collapse"
                                                                    href="#collapse-DBT" aria-expanded="true"
                                                                    aria-controls="collapse-DBT">
                                                                <label class="custom-control-label" for="DBT">Direct bank
                                                                    transfer
                                                                </label>
                                                                <div id="collapse-DBT" class="collapse"
                                                                    ...
                                                                    <div class="card-body p-0">
                                                                        ...
                                                                        elit. Necessitatibus ad quia doloremque odit quam
                                                                        magnam, officiis adipisci? Aperiam non tempore
                                                                        officia, accusantium quia pariatur delectus
                                                                        consequatur quis aspernatur blanditiis excepturi!
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label class="custom-control-label" for="CP">Check payments
                                                                </label>
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="COD" value="COD"
                                                                    name="payment_method" class="custom-control-input"
                                                                    role="button" data-toggle="collapse"
                                                                    href="#collapse-COD" aria-expanded="true"
                                                                    aria-controls="collapse-COD" checked>
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="PIP" value="PIP"
                                                                    name="payment_method" class="custom-control-input"
                                                                    role="button" data-toggle="collapse"
                                                                    href="#collapse-PIP" aria-expanded="true"
                                                                    aria-controls="collapse-PIP">
                                                                <label class="custom-control-label" for="PIP">PayPalWhat is
                                                                    PayPal?
                                                                </label>
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label class="custom-control-label" for="CC">Credit Card
                                                                    (Stripe)
                                                                </label>
...
@section('scripts')
    <script>
        $("[name='sfirst_name']").removeAttr('required');
        $("[name='slast_name']").removeAttr('required');
        $("[name='scountry']").removeAttr('required');
        $("[name='saddress']").removeAttr('required');
        $("[name='scity']").removeAttr('required');
        $("[name='sstate']").removeAttr('required');
        $("[name='spostcode']").removeAttr('required');
        $("[name='sphone']").removeAttr('required');
        $("[name='semail']").removeAttr('required');
        $(document).on('change', '#checkout-diff-address', function(e) {
            e.preventDefault();

            if ($(this).is(':checked')) {
                $("#diff-address").css("display", "block");
                ...
                $("[name='sfirst_name']").attr('required');
                $("[name='slast_name']").attr('required');
                $("[name='scountry']").attr('required');
                $("[name='saddress']").attr('required');
                $("[name='scity']").attr('required');
                $("[name='sstate']").attr('required');
                $("[name='spostcode']").attr('required');
                $("[name='sphone']").attr('required');
                $("[name='semail']").attr('required');\
                $(selector).attr('required');
            } else {
                $("#diff-address").css("display", "none");
